      ...
      return [
        {
          ...
          items: [
            { href: '/dashboard/doctor-portal?tab=queue', tab: 'queue', label: 'Consultation Queue', icon: 'Calendar' },
            { href: '/dashboard/doctor-portal?tab=notes', tab: 'notes', label: 'Clinical SOAP Notes', icon: 'FileText' },
            { href: '/dashboard/doctor-portal?tab=prescriptions', tab: 'prescriptions', label: 'Prescriptions & Labs', icon: 'Pill' },
            ...
            { href: '/dashboard/doctor-portal?tab=profile', tab: 'profile', label: 'Doctor Profile', icon: 'Stethoscope' },
...
export function Sidebar() {
  ...
  const isItemActive = (href: string, tab?: string) => {
    if (tab) {
      return (pathname === '/dashboard/hospital-portal' || pathname === '/dashboard/doctor-portal') && currentTab === tab;
    }
    if (href === '/dashboard/hospital-portal') {
      return pathname === '/dashboard/hospital-portal' && !currentTab;
    }
    if (href === '/dashboard/doctor-portal') {
      return pathname === '/dashboard/doctor-portal' && !currentTab;
    }
